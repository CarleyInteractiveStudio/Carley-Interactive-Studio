...
function initializeSearch() {
    ...
    const searchMap = [
        ...
        { name: 'Actualizaciones', id: 'updates', url: 'creative-engine.html', keywords: ['novedades', 'mejoras', 'creative code', 'cambios', 'actualizaciones'], available: true },
...
const translations = {
    es: {
        ...
        "sso-welcome-back": "¡Hola de nuevo!",
        "sso-continue-as": "Continuar como",
        "sso-not-you": "¿No eres tú?",
        ...
        "verify-home-title": "Portal de Autenticidad",
        "verify-home-desc": "Valida la legitimidad de un Certificado Profesional de Creative Engine.",
        "btn-verify-now": "Verificar Certificado",
        "verify-footer-note": "Los certificados oficiales contienen una firma digital y un sello de seguridad único.",
        "field-serial": "Código de Certificado",
        "field-cert-date": "Fecha de Emisión",
        "ce-nav-info": "Información",
        "ce-nav-updates": "Actualizaciones",
        "ce-nav-tutorials": "Tutoriales",
        "ce-nav-course": "Curso de Scripting",
        ...
        "ce-donate-1": "desarrollo continuo de la herramienta y servidores para mejor procesamiento y mejor calidad",
        "ce-donate-2": "",
        "btn-support": "Apoyar",
        ...
        "vs-donate-intro": "desarrollo continuo de la herramienta y servidores para mejor procesamiento y mejor calidad",
        ...
        "transparency-desc-long": "desarrollo continuo de la herramienta y servidores para mejor procesamiento y mejor calidad",
        ...
        "vs-donate-1": "desarrollo continuo de la herramienta y servidores para mejor procesamiento y mejor calidad",
        ...
        "ce-donate-intro": "desarrollo continuo de la herramienta y servidores para mejor procesamiento y mejor calidad",
        ...
        "ce-updates-title": "Actualizaciones",
        "ce-update-collab-title": "Actualización 6/4/2026 - Desarrollo Colaborativo",
        "ce-update-collab-desc": "Estamos desarrollando un sistema que permitirá el desarrollo en tiempo real para escuelas y pequeños estudios. Trabaja en equipo en el mismo proyecto sin interrupciones.",
        "ce-update-cc-title": "Actualización 3/4/2026",
        "ce-update-cc-desc": "Programa más fácil: Creative Code te ayuda a programar y corrige tus errores. Creative Code está para ayudarte a programar; actualmente disponible en español, todavía no es un modelo en sí, sino una pequeña herramienta que detecta patrones en tu código y trata de predecir lo que buscas para así generar un código o corregir tu código según lo que buscas. Viene con más de 1000 códigos de ejemplo y se planea extenderlo a más.",
        "tutorial-not-available": "Estamos preparando este tutorial detallado para ti. Estará disponible esta misma semana. ¿Te gustaría suscribirte a nuestro canal de YouTube para no perdértelo?",
    },
    en: {
        ...
        "verify-home-title": "Authenticity Portal",
        "verify-home-desc": "Validate the legitimacy of a Creative Engine Professional Certificate.",
        "btn-verify-now": "Verify Certificate",
        "verify-footer-note": "Official certificates contain a digital signature and a unique security seal.",
        "field-serial": "Certificate Code",
        "field-cert-date": "Issue Date",
        "btn-logout": "Log Out",
        ...
        "sso-welcome-back": "Welcome back!",
        "sso-continue-as": "Continue as",
        "sso-not-you": "Not you?",
        ...
        "donations-modal-desc": "continuous development of the tool and servers for better processing and quality",
        "privacy-intro-title": "Introduction",
        "privacy-data-title": "Data We Collect",
        "privacy-data-desc": "We collect basic information such as your email and username to manage your account and projects. We also store your public opinions if you choose to submit them.",
        "privacy-ads-title": "Advertising and Third Parties",
        "privacy-ads-desc": "We use Google AdSense to display advertisements. Google may use cookies to serve ads based on your previous visits to this site or other websites.",
        "privacy-rights-title": "Your Rights",
        "privacy-rights-desc": "You can request the deletion of your account and all associated data at any time through the profile section on our website.",
        ...
        "ce-nav-course": "Scripting Course",
        "ce-tutorial-ui-title": "Learn the Creative Engine interface",
        "ce-updates-title": "Updates",
        "ce-update-collab-title": "Update 6/4/2026 - Collaborative Development",
        "ce-update-collab-desc": "We are developing a system that will allow real-time development for schools and small studios. Work as a team on the same project without interruptions.",
        "ce-update-cc-title": "Update 3/4/2026",
        "ce-update-cc-desc": "Program easier: Creative Code helps you program and corrects your errors. Creative Code is here to help you program; currently available in Spanish, it is not yet a model itself, but a small tool that detects patterns in your code and tries to predict what you are looking for to generate or correct your code based on your needs. It comes with over 1000 example codes and is planned to be expanded further.",
        ...
        "tutorial-not-available": "We are preparing this detailed tutorial for you. It will be available later this week. Would you like to subscribe to our YouTube channel so you don't miss it?",
        "ce-donate-intro": "continuous development of the tool and servers for better processing and quality",
        ...
        "ce-donate-1": "continuous development of the tool and servers for better processing and quality",
        "ce-donate-2": "",
        "btn-support": "Support",
        ...
        "vs-donate-intro": "continuous development of the tool and servers for better processing and quality",
        ...
        "transparency-desc-long": "continuous development of the tool and servers for better processing and quality",
        ...
        "vs-donate-1": "continuous development of the tool and servers for better processing and quality",
    ...
    fr: {
        ...
        "donations-modal-desc": "développement continu de l'outil et des serveurs pour un mejor tratamiento y una mejor calidad",
        ...
        "ce-updates-title": "Mises à jour",
        "ce-update-collab-title": "Mise à jour 6/4/2026 - Développement Collaboratif",
        "ce-update-collab-desc": "Nous développons un système qui permettra le développement en temps réel pour les écoles et les petits studios. Travaillez en équipe sur le même projet sans interruptions.",
        "ce-update-cc-title": "Mise à jour 3/4/2026",
        "ce-update-cc-desc": "Programmez plus facilement : Creative Code vous aide à programmer et corrige vos erreurs. Creative Code est là pour vous aider à programmer ; actuellement disponible en espagnol, ce n'est pas encore un modèle en soi, mais un petit outil qui détecte des motifs dans votre code et tente de prédire ce que vous recherchez pour générer ou corriger votre code selon vos besoins. Il contient plus de 1000 exemples de codes et son extension est prévue.",
        ...
        "vs-donate-1": "développement continu de l'outil et des serveurs pour un mejor tratamiento y una mejor calidad",
    ...
    pt: {
        ...
        "donations-modal-desc": "desenvolvimento contínuo da ferramenta e servidores para mejor procesamiento e mejor calidad",
        "privacy-intro-title": "Introdução",
        "privacy-data-title": "Dados que recolhemos",
        "privacy-data-desc": "Recolhemos informações básicas como o seu e-mail e nome de utilizador para gerir a sua conta e os seus projetos. Também armazenamos as suas opiniões públicas se decidir enviá-las.",
        "privacy-ads-title": "Publicidade e Terceiros",
        "privacy-ads-desc": "Utilizamos o Google AdSense para apresentar anúncios. O Google pode utilizar cookies para apresentar anúncios baseados nas suas visitas anteriores a este site ou a outros sites.",
        "privacy-rights-title": "Os seus Direitos",
        "privacy-rights-desc": "Pode solicitar a eliminação da sua conta e de todos os dados associados a qualquer momento através da secção de perfil no nosso sítio Web.",
        ...
        "ce-updates-title": "Atualizações",
        "ce-update-collab-title": "Atualização 6/4/2026 - Desenvolvimento Colaborativo",
        "ce-update-collab-desc": "Estamos desenvolvendo um sistema que permitirá o desenvolvimento em tempo real para escolas e pequenos estúdios. Trabalhe em equipe no mesmo projeto sem interrupções.",
        "ce-update-cc-title": "Atualização 3/4/2026",
        "ce-update-cc-desc": "Programe más fácil: Creative Code ajuda você a programar e corrige seus erros. Creative Code está aqui para ajudá-lo a programar; atualmente disponível em espanhol, ainda não é um modelo em si, mas uma pequena ferramenta que detecta padrões no seu código e tenta prever o que você procura para gerar ou corrigir seu código de acordo com o que você busca. Vem com más de 1000 códigos de exemplo e planeja-se estender para mais.",
        ...
        "vs-donate-1": "desenvolvimento contínuo da ferramenta e servidores para mejor procesamiento e mejor calidad",
        ...
        "ce-donate-intro": "desenvolvimento contínuo da ferramenta e servidores para mejor procesamiento e mejor calidad",
    ...
    ru: {
        ...
        "donations-modal-desc": "непрерывная разработка инструмента и серверов для лучшей обработки и лучшего качества",
        ...
        "ce-updates-title": "Обновления",
        "ce-update-collab-title": "Обновление 6/4/2026 - Коллаборативная разработка",
        "ce-update-collab-desc": "Мы разрабатываем систему, которая позволит вести разработку в реальном времени для школ и небольших студий. Работайте в команде над одним проектом без перерывов.",
        "ce-update-cc-title": "Обновление 3/4/2026",
        "ce-update-cc-desc": "Программируйте проще: Creative Code помогает вам программировать и исправляет ваши ошибки. Creative Code здесь, чтобы помочь вам в программировании; в настоящее время доступен на испанском языке, это еще не сама модель, а небольшой инструмент, который обнаруживает закономерности в вашем коде и пытается предсказать, что вы ищете, чтобы сгенерировать или исправить ваш код в соответствии с вашими потребностями. Он поставляется с более чем 1000 примеров кодов и планируется его дальнейшее расширение.",
        ...
        "vs-donate-1": "непрерывная разработка инструмента и серверов для лучшей обработки и лучшего качества",
        ...
        "ce-donate-intro": "непрерывная разработка инструмента и серверов для лучшей обработки и лучшего качества",
    ...
    zh: {
        ...
        "donations-modal-desc": "持续开发工具和服务器，以实现更好的处理和质量",
        ...
        "ce-updates-title": "更新",
        "ce-update-collab-title": "更新 6/4/2026 - 协作开发",
        "ce-update-collab-desc": "我们正在开发一个允许学校和小型工作室进行实时开发的系统。在同一个项目上进行团队合作，不受干扰。",
        "ce-update-cc-title": "更新 3/4/2026",
        "ce-update-cc-desc": "编程更简单：Creative Code 帮助您编写程序并纠正错误。Creative Code 旨在为您提供编程帮助；目前仅支持西班牙语，它本身还不是一个模型，而是一个可以检测代码模式并尝试预测您的需求的小工具，从而根据您的需求生成或纠正代码。它包含 1000 多个示例代码，并计划进一步扩展。",
        ...
        "vs-donate-1": "持续开发工具和服务器，以实现更好的处理和质量",
        ...
        "ce-donate-intro": "持续开发工具和服务器，以实现更好的处理和质量",
    ...
    it: {
        ...
        "donations-modal-desc": "sviluppo continuo dello strumento e dei server per una migliore elaborazione e una migliore qualità",
        ...
        "ce-updates-title": "Aggiornamenti",
        "ce-update-collab-title": "Aggiornamento 6/4/2026 - Sviluppo Collaborativo",
        "ce-update-collab-desc": "Stiamo sviluppando un sistema che consentirà lo sviluppo in tempo reale per scuole e piccoli studi. Lavora in team sullo stesso progetto senza interruzioni.",
        "ce-update-cc-title": "Aggiornamento 3/4/2026",
        "ce-update-cc-desc": "Programma più facilmente: Creative Code ti aiuta a programmare e corregge i tuoi errori. Creative Code è qui per aiutarti a programmare; attualmente disponibile in spagnolo, non è ancora un modello vero e proprio, ma un piccolo strumento che rileva pattern nel tuo codice e cerca di prevedere cosa stai cercando per generare o correggere il tuo codice in base alle tue esigenze. Viene fornito con oltre 1000 codici di esempio e si prevede di estenderlo ulteriormente.",
        ...
        "vs-donate-1": "sviluppo continuo dello strumento e dei server per una migliore elaborazione e una migliore qualità",
    ...
    ja: {
        ...
        "donations-modal-desc": "より良い処理と品質のためのツールとサーバーの継続的な開発",
        ...
        "ce-updates-title": "アップデート",
        "ce-update-collab-title": "アップデート 6/4/2026 - 共同開発",
        "ce-update-collab-desc": "学校や小規模スタジオ向けにリアルタイム開発を可能にするシステムを開発中です。中断することなく同じプロジェクトでチームとして作業できます。",
        "ce-update-cc-title": "アップデート 3/4/2026",
        "ce-update-cc-desc": "より簡単なプログラミング：Creative Codeはプログラミングを助け、エラーを修正します。Creative Codeはあなたのプログラミングをサポートします。現在はスペイン語で利用可能です。まだモデル自体ではありませんが、コード内のパターンを検出し、あなたが探しているものを予測して、ニーズに合わせてコードを生成または修正する小さなツールです。1000以上のサンプルコードが付属しており、さらに拡張される予定です。",
        ...
        "vs-donate-1": "より良い処理と品質のためのツールとサーバーの継続的な開発",
    ...
    sw: {
        ...
        "donations-modal-desc": "maendeleo endelevu ya zana na seva kwa usindikaji bora na ubora bora",
        ...
        "ce-updates-title": "Updates",
        "ce-update-collab-title": "Update 6/4/2026 - Maendeleo ya Pamoja",
        "ce-update-collab-desc": "Tunatengeneza mfumo utakaoruhusu maendeleo ya wakati halisi kwa shule na studio ndogo. Fanya kazi kama timu kwenye mradi mmoja bila usumbufu.",
        "ce-update-cc-title": "Update 3/4/2026",
        "ce-update-cc-desc": "Programu rahisi zaidi: Creative Code inakusaidia kupanga programu na kusahihisha makosa yako. Creative Code iko hapa kukusaidia kupanga programu; kwa sasa inapatikana kwa Kihispania, bado si kielelezo chenyewe, bali ni chombo kidogo kinachotambua mifumo katika nambari yako na kujaribu kutabiri unachotafuta ili kuzalisha au kusahihisha nambari yako kulingana na unachotafuta. Inakuja na zaidi ya nambari za mfano 1000 na inapangwa kupanuliwa zaidi.",
        "vs-donate-1": "maendeleo endelevu ya zana na seva kwa usindikaji bora na ubora bora",
...
async function fetchDonationStats() {
    ...
    const stats = {
        CE: { current: 0, goal: 2500, donors: [] },
        VS: { current: 0, goal: 5000, donors: [] }
    };
...
function renderDonorsList() {
    ...
    container.innerHTML = allDonors.map(d => {
        const goal = d.product_id === 'CE' ? 2500 : 5000;
